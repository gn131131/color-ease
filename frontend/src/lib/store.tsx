...
interface PaletteColorDef {
    hex: string;
    hsl: { h: number; s: number; l: number };
}
interface PaletteDataDef {
    scheme: string;
    colors: PaletteColorDef[];
}
interface StoreState {
    palette: PaletteDataDef | null;
    setPalette: (p: PaletteDataDef) => void;
    saved: PaletteDataDef[];
    save: (p: PaletteDataDef) => void;
}
